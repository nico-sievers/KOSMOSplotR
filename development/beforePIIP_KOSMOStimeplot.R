...
#xlab="",ylab="",xaxt="n",yaxt="n")
    ...
    if(drawcontrol){
      if(any(dataset$Treat_Meso==control,dataset$Mesocosm==control,na.rm=T)){
        foundcontrol=T
